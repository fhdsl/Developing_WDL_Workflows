...
## File localization
When written as a fasta file, the human genome is a little over 3 GB in size. As such, it's very common that you will be putting much more reference data into a task than actual sample data. 



(pros and cons of including the ref in the docker image, which backends to do this on)

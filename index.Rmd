...
The course covers the following learning objectives. By the end of this course, you should be able to:

- **Write** an effective WDL Task
- **Link** multiple WDL tasks together into a Workflow
- **Organize** variables into structs
- **Scale** Multiple Samples via Arrays
- **Reuse** repeated tasks with aliases
- **Configure** settings for your execution engine
